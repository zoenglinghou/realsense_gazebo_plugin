...
protected:
  ...
  bool pointCloudIsDense_ = true;
  bool pointCloudColor_ = true;
  float pointCloudInvalidValue_ = std::numeric_limits<float>::quiet_NaN();
  ...
  float depthNoiseStddev_{0.0};
  float depthDropout_{0.0};
